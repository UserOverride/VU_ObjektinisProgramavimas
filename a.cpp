...
vector<string> availableLastnames={
    "Mustill",
"Landre",
"Hazley",
"Sydney",
...
void dataGeneration(int numberOfStudents){
    ofstream outFile("data.dat");
    srand(time(0));
    for (size_t i = 0; i < numberOfStudents; i++)
    {   
        outFile << availableNames[rand() % 1000] << " " << availableLastnames[rand() % 1000] << " ";
        int numberOfGrades = rand() % 101;
        outFile << numberOfGrades << " ";
